...
- 📱 I own an Android application [FlashApp](https://play.google.com/store/apps/details?id=com.flashapp.jamescollerton.flashapp&hl=en_GB&gl=US), which is used by photographers to calculate exposure for film cameras.
 
- 🌎 It's been downloaded thousands of times and is employed all over the world!
